...
public class PreviewView: UIView {
    ...
    public func createLayer(in rect: CGRect) -> CAShapeLayer{
    ...
    public func drawFaceWithLandmarks(face: VNFaceObservation) {
    ...
    public func drawLandmarks(on targetLayer: CALayer, faceLandmarkRegion: VNFaceLandmarkRegion2D, isClosed: Bool = true) {
    ...
    public func drawPointsOnLayer(rect:CGRect, landmarkPoints: [CGPoint], isClosed: Bool = true) -> CALayer {
